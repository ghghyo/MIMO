                        ...
                        <div className="col-xl-8 col-lg-8 lg-mb-50">
                            <div className="blog__details-left dark_image">
                                ...
                                <i className="fa-sharp fa-solid fa-ditto"></i>
                                    <div>
                                        <h5>Design is a comprehensive approach to creating digital products that are both visually appealing and environmentally sustainable</h5>                                
                                ...
                                <div className="row mt-35 mb-30">
                                    <div className="col-6">                                        
                                        <img className="img__full" src="../assets/img/blog/solarimage2.png" alt="blog-image" />
                                    </div>
                                    {/*<div className="col-6">                                        
                                        <img className="img__full" src="../assets/img/blog/solarimage2.png" alt="blog-image" />
    </div> */}
                                </div>
                                <p>Discover the voices advocating for smart cities, from industry experts and environmental enthusiasts to the communities benefitting from solar initiatives. We share stories that inspire change, emphasizing the importance of collective voices in shaping a sustainable future.</p>
