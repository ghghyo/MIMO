                            ...
                            <div className="all__sidebar">
                                ...
                                <div className="all__sidebar-help">
                                    <div className="all__sidebar-help-image">
                                        <img className="img__full" src="../assets/img/icon/getInTouch.png" alt="image" />
                        ...
                        <div className="col-xl-8 col-lg-8 lg-mb-50">
                            <div className="services__details-left">
                                ...
                                <div className="services__details-left-content">
                                    ...
                                    <p className="mb-25">{serviceDetails?.paragraph1}</p>
                                    <p className="mb-25">{serviceDetails?.paragraph2}</p>                        
                                    <div className="services__details-left-content-list">
                                        <span><i className="far fa-check"></i>{serviceDetails?.info1}</span>
                                    ...
                                    <div className="faq__area mt-35" id="accordionExample">
                                        <div className="faq__area-item">
                                            <h6 className="icon page " data-bs-toggle="collapse" data-bs-target="#collapseOne">{serviceDetails?.question1}</h6>
                                            <div id="collapseOne" className="faq__area-item-body" data-bs-parent="#accordionExample">
                                                <p>{serviceDetails?.answer1}</p>
                                            </div>
                                        </div>
                                        {/*
                                        <div className="faq__area-item">
